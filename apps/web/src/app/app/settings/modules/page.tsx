...
export default async function ModulesPage() {
  ...
  return (
    <SettingsShell
      title="Your products"
      subtitle="Each product is separate. Switching one on or off never changes the others, and switching one off stops Eva using it straight away — including anything it would have done in the background. Your records stay either way."
      current="modules"
    >
      {!organisation ? (
        <NoOrganisation />
        ...
        <p className="text-sm text-muted-foreground">
          {`Your role can't see ${organisation.name}'s products. Ask an owner.`}
        </p>
      ) : (
