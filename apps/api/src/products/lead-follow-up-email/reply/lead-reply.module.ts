...
/**
 * Answering an enquiry (slice 3.1c-3).
 *
 ...
 * `resolveSendingMailbox`."* This is that slice.
 *
 ...
 * lives here rather than inside `capabilities/mailbox` where the send code is.
 */
@Module({
  imports: [MailboxesModule, ReplyDecisionModule],
