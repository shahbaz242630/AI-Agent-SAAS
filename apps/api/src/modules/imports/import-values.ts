/**
 * Semantic value parsing (plan §3): the raw strings staged from a file are
 * converted to the canonical invoice values. Amounts become integer minor
 ...
 * staging and confirm parse identically (plan §3: "validated against rules
 * shared with createInvoiceRequestSchema").
 */
